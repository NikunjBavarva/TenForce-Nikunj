...
namespace Test_Taste_Console_Application.Domain.Services
{
    ...
    public class ScreenOutputService : IOutputService
    {
        ...
        {
            Console.WriteLine("Loading all Planets and their Moons...");
        ...
        public void OutputAllMoonsAndTheirMassToConsole()
        {
            ...
            Console.WriteLine("Loading all Moons and their Mass...");
        ...
        public void OutputAllPlanetsAndTheirAverageMoonGravityToConsole()
        {
            ...
            Console.WriteLine("Loading all Planets and their average Moon gravity...");
        ...
        public void OutputAllPlanetsAndTheirAverageMoonTemperatureToConsole()
        {
            ...
            ConsoleWriter.CreateTitleHeader("Loading planets along with the average temperatures of their moons...", new[] { 80 });
            ...
            var columnSizes = new[] { 20, 20, 40 };
            var columnLabels = new[]
            {
                OutputString.PlanetId, OutputString.NumberOfMoons, OutputString.PlanetMoonAverageTemperature
            };
            ...
            foreach (Planet planet in planets)
            {
                if (planet.HasMoons())
                {
                    ConsoleWriter.CreateText(new string[] { $"{planet.Id}", $"{ planet.Moons.Count()}", $"{planet.AverageMoonTemperature}" }, columnSizes);
            ...
            /*
                Example output showing planets with their moons and the average temperature of those moons:

                Planet   | Number of Moons | Average Moon Temperature (K)
                ----------------------------------------------------------
                Earth    | 1               | 220
                Jupiter  | 4               | 130
                Saturn   | 3               | 95
                ...
                Notes:
                - Only planets with at least one moon are included.
                - Average moon temperature is calculated from available moon temperature data.
            */
